/* The following code was generated by JFlex 1.4.3 on 12/6/14 10:13 PM */
 ...
 * on 12/6/14 10:13 PM from the specification file
 * <tt>Octave.flex</tt>
 */
class OctaveLexer implements FlexLexer {
  ...
  private Set<Character> setCharactersAfterIdentifier =
    new HashSet<>(Arrays.asList('=', '}', ']', ')', '.', '/', '\\', '*', '^', '&', '|', ':', '@', '<', '>'));
  private Set<Character> setCharactersBeforeStringLiteral =
    new HashSet<>(Arrays.asList('=', ',', ';', '{', '[', '(', '/', '\\', '+', '-', '*', '^', '&', '|', '~', ':', '@', '<', '>', '!'));
