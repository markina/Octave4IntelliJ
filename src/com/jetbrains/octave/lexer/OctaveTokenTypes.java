...
import com.jetbrains.octave.parser.OctaveElementType;
...
public interface OctaveTokenTypes {
  ...
  public static final TokenSet SET_STRING_NUMBER_LITERAL = TokenSet.create(
    INTEGER_LITERAL, FLOAT_NUMBER_LITERAL, COMPLEX_LITERAL, HEX_INTEGER, STRING, E_KEYWORD, INF_KEYWORD, NAN_KEYWORD, NA_KEYWORD,
    PI_KEYWORD, EPS_KEYWORD, REALMAX_KEYWORD, REALMIN_KEYWORD,
  ...
  public static final IElementType LEFT_DIVISION = new OctaveElementType("LEFT_DIVISION");  // /
  ...
  public static final IElementType OPERATION_LEFT_DIV_EQ = new OctaveElementType("OPERATION_LEFT_DIV_EQ");
  ...
  public static final TokenSet SET_EQ_OR_OPERATION_EQ = TokenSet.create(
    EQ, OPERATION_PLUS_EQ, OPERATION_MINUS_EQ, OPERATION_MULT_EQ, OPERATION_DIV_EQ, OPERATION_LEFT_DIV_EQ, OPERATION_POWER_EQ,
  ...
  public static final TokenSet SET_KEYWORD_OR_CONST = TokenSet.orSet(SET_KEYWORD, SET_CONST);
  ...
  public static final TokenSet OPERATORS = TokenSet.create(
    ...
    OPERATION_DOT_POWER_EQ, NOT, OR, AND, DOUBLE_OR, DOUBLE_AND, LT, GT, EQEQ, GE, LE, NOTEQ, EQ
  );

  public static final TokenSet OPERATORS_WITH_SPACE = TokenSet.create(
    DOT_DIVISION, DOT_LEFT_DIVISION, DOT_MULTIPLICATION, DOT_PLUS, DOT_MINUS, DOT_POWER, MINUS, PLUS, MULTIPLICATION, DIVISION,
    LEFT_DIVISION, POWER, OPERATION_PLUS_EQ, OPERATION_AND_EQ,
    OPERATION_OR_EQ, OPERATION_MINUS_EQ, OPERATION_MULT_EQ, OPERATION_DIV_EQ, OPERATION_LEFT_DIV_EQ, OPERATION_POWER_EQ,
    OPERATION_DOT_PLUS_EQ, OPERATION_DOT_MINUS_EQ, OPERATION_DOT_MULT_EQ, OPERATION_DOT_DIV_EQ, OPERATION_DOT_LEFT_DIV_EQ,
    OPERATION_DOT_POWER_EQ, OR, AND, DOUBLE_OR, DOUBLE_AND, LT, GT, EQEQ, GE, LE, NOTEQ, EQ,
    EQ, OPERATION_PLUS_EQ, OPERATION_MINUS_EQ, OPERATION_MULT_EQ, OPERATION_DIV_EQ, OPERATION_LEFT_DIV_EQ, OPERATION_POWER_EQ,
    OPERATION_DOT_PLUS_EQ, OPERATION_DOT_MINUS_EQ, OPERATION_DOT_MULT_EQ, OPERATION_DOT_DIV_EQ,
    OPERATION_DOT_LEFT_DIV_EQ, OPERATION_DOT_POWER_EQ, OPERATION_AND_EQ, OPERATION_OR_EQ, STRING
  );
}
