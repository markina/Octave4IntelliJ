...
public interface OctaveTokenTypes {
  ...
  public static final TokenSet SET_STRING_NUMBER_LITERAL = TokenSet.create(
    INTEGER_LITERAL, FLOAT_NUMBER_LITERAL, COMPLEX_LITERAL, HEX_INTEGER, STRING, E_KEYWORD, INF_KEYWORD, NAN_KEYWORD, NA_KEYWORD, PI_KEYWORD, EPS_KEYWORD, REALMAX_KEYWORD, REALMIN_KEYWORD,
