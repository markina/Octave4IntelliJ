...
public class OctaveRunConfiguration extends AbstractRunConfiguration implements OctaveRunConfigurationParams {
  public static final String SCRIPT_NAME = "SCRIPT_NAME";
  public static final String PARAMETERS = "PARAMETERS";
  private String myScriptName;
  private String myScriptParameters;

  protected OctaveRunConfiguration(Project project, ConfigurationFactory configurationFactory) {
    super(project, configurationFactory);
  }

  @Override
  public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment env) throws ExecutionException {
    return new OctaveCommandLineState(this, env);
  }

  @NotNull
  @Override
  public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
    return new OctaveRunConfigurationEditor(this);
  }
  ...
  public static void copyParams(OctaveRunConfigurationParams source, OctaveRunConfigurationParams target) {
